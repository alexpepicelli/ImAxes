...
public class AxesSceneManager : MonoBehaviour
{
    ...
    static AxesSceneManager _instance;
    public static AxesSceneManager Instance
    {
        get { return _instance ?? (_instance = FindObjectOfType<AxesSceneManager>()); }
    }
